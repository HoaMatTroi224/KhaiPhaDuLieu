...
Người dùng đăng nhập/đăng ký trên Frontend
Tạo dự án và tải lên tài liệu (PDF)
Backend lưu trữ và xử lý tài liệu, trích xuất nội dung, tạo bản tóm tắt và các chunk embedding
Frontend hiển thị bản tóm tắt ra màn hình
Chat AI - Người dùng có thể:
