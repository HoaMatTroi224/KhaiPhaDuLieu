...
2. Chuyển PDF sang Markdown bằng PyMuPDF4LLM
3. Chuyển Markdown sang HTML và dùng BeautifulSoup để trích metadata
4. Parse structured body bằng GROBID
5. Trả về dict unified output
...
def clean_line(line: str) -> str:
    """Làm sạch một dòng: bỏ markdown và chuẩn hoá khoảng trắng."""
...
def clean_body_text(raw_body: str) -> str:
    """
    Làm sạch body text từ GROBID: xoá caption, citation, chuẩn hoá khoảng trắng.
    """
